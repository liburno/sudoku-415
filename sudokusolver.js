...
class SSolver {
    ...
    trysolve() {
        if (!this.getcandidates()) return false;
        var r2, c2, r3, c3;
        r2 = c2 = r3 = c3 = -1;
        var i = 0, j = 0;
        var fl = 0;
...
console.log('----------------------------------------------------')
var aa = fs.readFileSync("out.txt", { encoding: 'utf8' });
var ss = new SSolver(aa);
ss.trysolve();

fs.writeFileSync(`out1.txt`, ss.toString(), { encoding: 'utf8' });
fs.writeFileSync('out.json',JSON.stringify(ss,null,2),{encoding:'utf8'})